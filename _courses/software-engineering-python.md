---
layout: course
title: "Software Engineering: Python Course"
date: 2023-05-08 15:29:37 +0100
comments: true
duration: 56 hrs
rating: 5
track: "software"
...
## Prerequisites
To participate in this course, **we require students posses knowledge of Version Control Software e.g. Git**. Familiarity with collaboration platforms like Github.com and/or Bitbucket.org is a plus. Basic familiarity with computer science concepts such as, what programming languages are, web and internet systems, operating systems, the ability to describe each of these items and give examples without necessarily knowing all the details of how they work is also considered beneficial. Participants who already have experience with another programming language and/or databases will have an edge in this course.[§]

[§] **Students who are familiar with items 2 - 10 from the [Software Engineering Foundation Course](https://istemlabs.africa/software-engineering-track/foundation-course) course already meet these prerequisites.**
