 ...
 1. 4hrs - Essential HTML and CSS 
    ...
    * CSS overview
      - Basic directives
        ...
        - CSS opacity
        - Layout:float, inline, inline-block
      - Using Bootstrap
 3. 2hrs  - Project A: The student is tasked with building a correctly-styled website using the Bootstrap CSS package.
 1. 4hrs - Essential Javascript
    * Comments, Variables and Operators
    * Data Types and sample operations allowed
    * Conditionals and Loops
    * Functions and Events
 1. 2hrs - Project B: The student is tasked with building a functional website using Javascript and ensure it’s correctly-styled using the  Bootstrap CSS Framework
