...
## Objective
Participants engage in ideation, design and development of a simple barebones (no-framework used) PHP application connected to a DataBase. 
...
## Certification
Upon successful completion of this course, participants will be awarded the “iSTEMLabsAfrica Software Engineering: Beginner Course III ” certificate.
...
1. 3hrs - Solution Architecture ) 
1. 2hrs - Project A? 
1. 5hrs - Introduction to OOP (PHP) 
1. 1hr - Project B?) 
1. 2hrs -  Introduction to Database Design  
1. 2hrs -  Introduction to Testing Code 
1. 1hr -  Next Steps
